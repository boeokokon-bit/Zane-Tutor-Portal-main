...
const readinessColor: Record<string, string> = {
  proficient: 'bg-success/10 text-success border-success/20',
  competent: 'bg-accent/10 text-accent border-accent/20',
            ...
            <div className="space-y-2 mb-3">
              {assessment.subject_scores.map(ss => (
                <div key={ss.subject} className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-medium w-28 truncate text-left">{SUBJECT_LABELS[ss.subject as Subject] || ss.subject}</span>
